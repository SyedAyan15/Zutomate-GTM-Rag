...
export default function MessageInput({ onSendMessage, disabled }: MessageInputProps) {
  ...
  return (
    <div className="p-2 md:p-4 bg-[var(--navy-card)] border-t border-[var(--border)]">
      <form onSubmit={handleSubmit} className="flex items-end space-x-2 max-w-4xl mx-auto">
        <div className="flex-1 flex">
          <textarea
            ...
            rows={1}
            className="input-field w-full resize-none min-h-[50px] max-h-32"
          />
        </div>
        ...
        <button
          ...
          className={`btn-secondary !p-0 !min-w-[50px] !h-[50px] !rounded-xl !border-none !bg-[var(--navy-card)] hover:!bg-white/10 flex items-center justify-center transition-all ${isRecording
              ? '!bg-red-500 !text-white animate-pulse'
              : isTranscribing
                ? '!bg-[var(--orange)] !text-white cursor-wait'
        ...
        <button
          ...
          className="btn-primary !p-0 !min-w-[50px] !h-[50px] !rounded-xl flex items-center justify-center disabled:opacity-30 disabled:cursor-not-allowed"
        >
